*&---------------------------------------------------------------------*
*& Report ZABAP_MICHSYNTAX_HASHED_INT
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZABAP_MICHSYNTAX_HASHED_INT.
...
DATA: it_mara TYPE TABLE OF zmara_table,
      ...
      gt_employee TYPE HASHED TABLE OF tp_emp WITH UNIQUE KEY employee_id bukrs, "PERMITE REISTROS DUPLICADOS, PARA NO ADMITIR DUPLICADOS SOLO QUITO EL NON-
...
LOOP AT gt_employee INTO gs_employee.
   ...
   MODIFY TABLE gt_employee FROM gs_employee TRANSPORTING first_name CTC.
...
* READ TABLE gt_employee INTO gs_employee INDEX 1.
 ...
 READ TABLE gt_employee INTO gs_employee WITH KEY employee_id = 'ZMT04'.
