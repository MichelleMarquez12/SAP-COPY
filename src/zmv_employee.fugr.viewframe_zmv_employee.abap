*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_EMPLOYEE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_EMPLOYEE        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_EMPLOYEE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_EMPLOYEE_EXTRACT
TOTAL = ZMV_EMPLOYEE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_EMPLOYEE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_EMPLOYEE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_EMPLOYEE_EXTRACT
TOTAL = ZMV_EMPLOYEE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_EMPLOYEE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_EMPLOYEE'
...
TOTAL = ZMV_EMPLOYEE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_EMPLOYEE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_EMPLOYEE-UPD_FLAG NE SPACE.
